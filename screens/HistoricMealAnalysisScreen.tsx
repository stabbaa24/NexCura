                    ...
                    <View style={styles.mealDetails}>
                        {item.photo && (
                            <Image
                                ...
                                onError={(e) => {
                                    console.log("URL de l'image qui pose problème:", item.photo);
                                    console.log("URL complète utilisée:", getFullImageUrl(item.photo));
                        ...
                        <View style={styles.glycemicSection}>
                            ...
                            <View style={styles.glycemicItem}>
                                ...
                                <Text style={[styles.glycemicValue, styles.glycemicImpact]}>
                                    {item.impact_glycemique ?
                                        (typeof item.impact_glycemique === 'object' ?
                                            `${item.impact_glycemique.avant_repas || 0} → ${item.impact_glycemique.apres_repas || 0} mg/dL` :
